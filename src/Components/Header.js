        ...
        >
            <div className="socialLinks">
                ...
                <div className="linksDiv svgSize">
                    <a href='https://github.com/coder-pixel' target="_blank" className='github'>
                    ...
                    <a href='https://www.linkedin.com/in/sauvik-goel-ba8847178/' target="_blank" className='linkedin'>
            ...
            <div className='moveRight svgSize'>
                <a href="mailto:sauvikgoel@gmail.com" className='mail'>
