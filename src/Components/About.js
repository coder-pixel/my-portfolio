  ...
  return (
    ...
    >
      <div className="aboutme_content">
        ...
        <p>
          I’m a Software Developer with years of experience building dynamic web
          applications using React, Next.js, TypeScript, and GraphQL/Rest API's.
        </p>
        <p>
          I specialize in creating scalable, high-performance solutions with a
      ...
      <div className="aboutme_content skills_content">
        ...
        <div className="subContent">
          ...
          <p>
            React, NextJS, TypeScript, Redux, HTML5/CSS3, Express/Mongo DB,
            MySQL, GraphQL, RESTful API, Stripe
          </p>
        </div>
        <div className="subContent">
          <h2 className="bold_subheading">Tools</h2>
          <p>Git/Github, AWS/Vercel Deployment, Heroku, Netlify, VScode</p>
        </div>
      </div>
    </motion.div>
  );
